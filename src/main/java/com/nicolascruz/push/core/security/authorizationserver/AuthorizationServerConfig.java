...
public class AuthorizationServerConfig {
    ...
    @Bean
    public AuthorizationServerSettings providerSettings(AuthorizationProperties properties) {
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> jwtCustomizer(UserRepository userRepository) {
        return context -> {
            ...
            if (authentication.getPrincipal() instanceof User user) {
                ...
                com.nicolascruz.push.domain.model.User userApp = userRepository.findByEmail(user.getUsername()).orElseThrow();
                ...
                context.getClaims().claim("user_id", userApp.getId().toString());
